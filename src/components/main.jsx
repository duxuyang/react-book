  ...
  type=(msg)=>{//类型
	...
	render() {
		...
		<div className="search">
			<div className="cen" onClick={this.search}>
							...
							this.state.freelist.map((val,index)=>{
								return <li key={index}>
									<Link to={{pathname:'/detail',id:val.id }}>
											...
											<div className="tname">{val.name}</div>
											<div className="tauthor">{val.author}</div>
									</Link>
								</li>
							})
						}
					...
					<ul>
						<li>
							<a href="">
								...
								<div className="tname">择天记</div>
								<div className="tauthor">丽丽</div>						
							</a>
						</li>
						<li>
							<a href="">
